...
<div class="block header_home flex">

    <div class="forme_header_home b_deg">
        ...
        <i class="fa-solid fa-user gradient_text"></i>
        </div>
        <div class="number_header_home col_w">
            <h2>200</h2>
        </div>
    </div>

    <div class="forme_header_home">
